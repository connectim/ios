...
- (void)initControlBtn {
    ...
    [cancelBtn setTitle:LMLocalizedString(@"Common Cancel", nil) forState:UIControlStateNormal];
    ...
    [confirmBtn setTitle:LMLocalizedString(@"Common OK", nil) forState:UIControlStateNormal];

...
#define CellLineEdgeInsets UIEdgeInsetsMake(5, 10, 5, 10)
...
- (instancetype)initWithDataArray:(NSArray *)dataArray
    ...
    if (self = [super initWithFrame:CGRectMake(0, 0, SCREEN_WIDTH, SCREEN_HEIGHT)]) {
        ...
        _tableView.separatorColor = [UIColor colorWithWhite:0 alpha:0.05];
        _tableView.backgroundColor = [UIColor colorWithWhite:1 alpha:0.65];
        ...
        //注册cell
        [_tableView registerClass:[MeunCell class] forCellReuseIdentifier:@"cell"];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    MeunCell *cell = [tableView dequeueReusableCellWithIdentifier:@"cell"];
...
- (void)drawRect:(CGRect)rect {
    ...
    if (self.direction == kLrdOutputViewDirectionLeft) {
        ...
        CGContextAddLineToPoint(context, startX + 7, startY - 6);

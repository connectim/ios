...
- (void)showNumberBadgeWithValue:(NSInteger)value
{
    ...
    if (value >= 10) {
        self.badgeCenterOffset = CGPointMake(self.badgeCenterOffset.x, self.badgeCenterOffset.y);
        CGRect frame = self.badge.frame;
        frame.size.width += frame.size.height * 0.3;
...
- (void)badgeInit
{
    ...
    CGFloat redotWidth = AUTO_WIDTH(20);

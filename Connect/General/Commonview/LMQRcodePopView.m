...
@implementation LMQRcodePopView

+ (LMQRcodePopView *)sharedInstance {
    static LMQRcodePopView *sharedClient = nil;
    static dispatch_once_t onceToken;
    dispatch_once(&onceToken, ^{
        sharedClient = [[LMQRcodePopView alloc]init];
    });
    return sharedClient;
}
...
- (void)drawRect:(CGRect)rect{
    ...
    if ([LMQRcodePopView sharedInstance].shadeBackgroundType == ShadeBackgroundTypeSolid) {
...
- (void)touchesBegan:(NSSet<UITouch *> *)touches withEvent:(UIEvent *)event {
    if ([LMQRcodePopView sharedInstance].tapOutsideToDismiss) {
          [[LMQRcodePopView sharedInstance] hideAnimated:YES withCompletionBlock:nil];
    }
}

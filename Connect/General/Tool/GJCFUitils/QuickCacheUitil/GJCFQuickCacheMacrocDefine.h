...
//  GJCommonFoundation
//
//  Created by KivenLin on 14-10-16.
...
/**
 *  在指定路径创建文件保护等级为NSFileProtectionComplete目录，返回BOOL结果
 */
#define GJCFFileProtectCompleteDirectoryCreate(pathObj) [GJCFQuickCacheUitil createProtectCompleteDirectory:pathObj]

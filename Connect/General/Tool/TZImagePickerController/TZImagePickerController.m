...
- (void)showAlertWithTitle:(NSString *)title {
    if (iOS8Later) {
        ...
        [alertController addAction:[UIAlertAction actionWithTitle:LMLocalizedString(@"Chat I know", nil) style:UIAlertActionStyleDefault handler:nil]];
        [self presentViewController:alertController animated:YES completion:nil];
    } else {
        [[[UIAlertView alloc] initWithTitle:title message:nil delegate:nil cancelButtonTitle:LMLocalizedString(@"Chat I know", nil) otherButtonTitles:nil, nil] show];
    }
}
...
- (void)showProgressHUD {
    if (!_progressHUD) {
        ...
        _HUDLable.text = LMLocalizedString(@"Common Loading", nil);
...
- (void)setSelectedAssets:(NSMutableArray *)selectedAssets {
    ...
    for (id asset in selectedAssets) {
        ...
        [_selectedModels objectAddObject:model];
    }
}
...
- (void)pushViewController:(UIViewController *)viewController animated:(BOOL)animated {
    ...
    if (self.childViewControllers.count > 0) {
        ...
        [backButton setTitle:LMLocalizedString(@"Chat Back", nil) forState:UIControlStateNormal];
...
- (void)viewDidLoad {
    ...
    self.navigationItem.title = LMLocalizedString(@"Chat Photo", nil);

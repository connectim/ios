...
#define iOS7Later (SYSTEM_VERSION_GREATER_THAN_OR_EQUAL_TO(@"7.0"))
#define iOS8Later (SYSTEM_VERSION_GREATER_THAN_OR_EQUAL_TO(@"8.0"))
#define iOS9Later (SYSTEM_VERSION_GREATER_THAN_OR_EQUAL_TO(@"9.0"))
#define iOS9_1Later (SYSTEM_VERSION_GREATER_THAN_OR_EQUAL_TO(@"9.1"))
